...
def reg_server(root,frame1,name,sex,zone,city,passw):
    ...
    Label(frame1, text=txt, font=('Helvetica', 50, 'bold')).grid(row = 2, column = 1, columnspan=2)
...
def Register(root,frame1):
    ...
    Label(frame1, text="Register Voter", font=('Helvetica', 50, 'bold')).grid(row = 0, column = 2, rowspan=1)
